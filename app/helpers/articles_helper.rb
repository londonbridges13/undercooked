module ArticlesHelper
  ...
  def check_resource(resource) #resource object here
    ...
    feed = Feedjira::Feed.fetch_and_parse "http://feeds.feedburner.com/MinimalistBaker/".dup.force_encoding(Encoding::UTF_8)#resource.resource_url#force_encoding('UTF-8')
