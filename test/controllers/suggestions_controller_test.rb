...
class SuggestionsControllerTest < ActionController::TestCase
  ...
  test "should create suggestion" do
    assert_difference('Suggestion.count') do
      post :create, suggestion: { evidence: @suggestion.evidence, reason: @suggestion.reason, rejected: @suggestion.rejected }
    end
  ...
  test "should update suggestion" do
    patch :update, id: @suggestion, suggestion: { evidence: @suggestion.evidence, reason: @suggestion.reason, rejected: @suggestion.rejected }
    assert_redirected_to suggestion_path(assigns(:suggestion))
  end
